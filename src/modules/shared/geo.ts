...
function parseEWKBPoint(hex: string): GeoPoint {
    ...
    const readUInt32 = (o: number) =>
        isLE ? buf.readUInt32LE(o) : buf.readUInt32BE(o);
    const readDouble = (o: number) =>
        isLE ? buf.readDoubleLE(o) : buf.readDoubleBE(o);
...
export const pointTransformer = {
    to: (value: GeoPoint | null) =>
        value
            ...
            : null,
    from: (
        value: string | { type: string; coordinates: number[] } | null
    ): GeoPoint | null => {
